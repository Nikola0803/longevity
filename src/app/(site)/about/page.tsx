...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-background-800 text-foreground-100">
      ...
      <main>
        {/* Hero */}
        <section className="relative pt-[96px] bg-background-900 border-b border-background-200/60 overflow-hidden">
          ...
          <div className="relative w-full max-w-[1440px] mx-auto px-6 md:px-10 py-20 md:py-28 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7">
              <div className="flex items-center gap-3 mb-5">
                ...
                <span className="font-mono text-[10px] tracking-[0.28em] text-primary-500 uppercase">About Longevity Peptides</span>
              </div>
              ...
              <p className="text-[16px] text-foreground-400 leading-relaxed max-w-xl">
                The research peptide market grew faster than its standards did. Most suppliers sell on confidence and a nice label. Purity claims you can't check, sourcing you can't see. Longevity Peptides exists to be the supplier where you don't have to take our word for it.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
              <div className="lg:col-span-4">
                <div className="flex items-center gap-3 mb-4">
                  <span className="font-mono text-[10px] tracking-[0.28em] text-primary-500 uppercase">/ 01 · Why Longevity Peptides</span>
              ...
              <div className="lg:col-span-7 lg:col-start-6">
                <p className="text-[15px] text-foreground-400 leading-relaxed mb-5">
                  Every research-peptide site says "lab tested." Very few make it easy to see what that actually means for the vial in front of you. Which lab, what method, what the result was, and whether it's still current. We built Longevity Peptides around the parts most vendors treat as an afterthought.
                </p>
        ...
        <section className="border-t border-background-200/60 bg-background-900/50 py-20">
          <div className="w-full max-w-[1440px] mx-auto px-6 md:px-10">
            <div className="max-w-3xl">
              <div className="flex items-center gap-3 mb-4">
                <span className="font-mono text-[10px] tracking-[0.28em] text-primary-500 uppercase">/ 04 · What Longevity Peptides Is Not</span>
                <span className="w-8 h-px bg-primary-500/40"></span>
              </div>
              <p className="text-[15px] text-foreground-300 leading-relaxed mb-4">
                Longevity Peptides is a research-use-only supplier. Our products are sold strictly for laboratory and in-vitro research. Not for human consumption, not for medical use, and not as a treatment or cure for any condition. We don't make therapeutic claims, and we're not going to start.
              </p>
