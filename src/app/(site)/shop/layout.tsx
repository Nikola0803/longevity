...
export const metadata: Metadata = {
  ...
  description:
    "Browse the full Longevity Peptides research peptide catalog by category or compound. Every product ships lyophilized with a published, batch-searchable Certificate of Analysis.",
