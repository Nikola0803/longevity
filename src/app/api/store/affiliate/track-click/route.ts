...
// POST /api/store/affiliate/track-click { ref_code, landing_url }
// Best-effort click log; commission itself is attributed at checkout time
// (see lib/order-engine.ts) when the coupon/ref actually converts.
